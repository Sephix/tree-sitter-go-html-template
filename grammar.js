  ...
  rules: {
    ...
    range_action: ($) =>
      seq(
        $._left_delimiter,
        "range",
        choice($.range_variable_definition, field("range", $._pipeline)),
        $._right_delimiter,
    ...
    variable_definition: ($) =>
      seq(field("variable", $.variable), ":=", field("value", $._pipeline)),
